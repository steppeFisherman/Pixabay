...
typealias MusicListener = (data: DataUi.Hit) -> Unit

class MusicFragmentAdapter(private val listener: MusicListener, private val loadImage: LoadImage) :
    ListAdapter<DataUi.Hit, MusicFragmentAdapter.MainHolder>(ItemCallback),
