...
typealias ScienceListener = (data: DataUi.Hit) -> Unit

class ScienceFragmentAdapter(
    private val listener: ScienceListener,
    private val loadImage: LoadImage
) :
    ListAdapter<DataUi.Hit, ScienceFragmentAdapter.MainHolder>(ItemCallback),
