...
typealias FeelingsListener = (data: DataUi.Hit) -> Unit

class FeelingsFragmentAdapter(private val listener: FeelingsListener, private val loadImage: LoadImage) :
    ListAdapter<DataUi.Hit, FeelingsFragmentAdapter.MainHolder>(ItemCallback),
