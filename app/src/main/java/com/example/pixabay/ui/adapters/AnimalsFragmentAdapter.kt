...
typealias AnimalsListener = (data: DataUi.Hit) -> Unit

class AnimalsFragmentAdapter(private val listener: AnimalsListener, private val loadImage: LoadImage) :
    ListAdapter<DataUi.Hit, AnimalsFragmentAdapter.MainHolder>(ItemCallback),
