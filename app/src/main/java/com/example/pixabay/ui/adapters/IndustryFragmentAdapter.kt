...
typealias IndustryListener = (data: DataUi.Hit) -> Unit

class IndustryFragmentAdapter(
    private val listener: IndustryListener,
    private val loadImage: LoadImage
) :
    ListAdapter<DataUi.Hit, IndustryFragmentAdapter.MainHolder>(ItemCallback),
